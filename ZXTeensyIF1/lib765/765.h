...
typedef void (*lib765_error_function_t)(int debuglevel, const char *fmt, va_list ap);

extern lib765_error_function_t lib765_error_function;

void lib765_default_error_function(int debuglevel, const char *fmt, va_list ap);
...
fdc_byte fdc_read_data (FDC_PTR self) __attribute__((hot, optimize("O3")));
/* Read the FDC's main control register */
fdc_byte fdc_read_ctrl (FDC_PTR self) __attribute__((hot, optimize("O3")));
