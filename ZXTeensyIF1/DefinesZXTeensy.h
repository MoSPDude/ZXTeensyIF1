...
#define ZXTEENSY_VERSION "20260801"
...
#define GENIE128_ROM_PATH ((const char*)F("/ZXTEENSY/genie128.rom"))
...
// Run the Teensy 4.1 with slight overclock at 720MHz
#define TEENSY_CLK_FREQ 720000000ULL
...
// Allow ~125ms for button to debounce
#define BUTTON_DELAY_MS 125
...
// MLD flash erasure delay
#define MLD_ERASE_DELAY_MS 25
#define MLD_ERASE_DELAY_CNT ((MLD_ERASE_DELAY_MS * TEENSY_CLK_FREQ) / (TICK_CYCCNT * 1000))
